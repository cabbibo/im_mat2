...
public class CurveEditor : Editor
{
    ...
    void OnEnable(){
        ...
        // Get our curve and hide the audio component for prettiness
        curve = (Curve)target;
    ...
    {   
        ...
        // Drawing all of our gui
        Draw();

        // Doing the juicy audio
        CheckForPlay();
     ...
     void CheckForPlay(){
         ...
         // 'rachet' by playing only after we have moved
         // a certain amount, and change pitch based on length
         // to start
    ...
    void Input()
    {
        ...
        // ending mouse movement
        if (guiEvent.type == EventType.MouseUp  && guiEvent.button == 0)
        {            

            // if curve has changed bake it
    ...
    void Draw(){
        ...
        // if we have a curve & its enabled
        if( curve ){
        if( curve.enabled  ){
       ...
       /*
            ...
            */
            ...
            // Got through every point and set it
            ...
            // Show our actual baked points so 
            ...
            */
            ...
            // Draw at every even basis
            // based on how many we want to draw
            ...
            //Make points that we can click on to to add new points
        ...
        for( int i = 0; i < curve.positions.Count; i++ ){
            ...
            */ 
            ...
            if(i == curve.selectedPoint ){
                ...
                Handles.color = Color.HSVToRGB(.9f,1,1);
            }
            ...
            */ 
            if( (i == curve.selectedPoint || curve.showAllControls ) && curve.showMoveControls){
                ...
                // Drawing a value back to your original position
                if( isMoving){
            ...
            // Draw one handle for each direction, and save out if it has moved
            ...
            // Scale Controls
            // will need to draw 1 for forward, one for backwards
            // and two for the side that are linked!
             if( (i == curve.selectedPoint || curve.showAllControls ) && curve.showScaleControls ){
                ...
                // draw back to original position
            ...
            // Draw pretty arrow to help orieng ourselves
        ...
        if( hasChanged ){
            ...
            */
            ...
            if( curve.haveFun ){
                ...
                draw some basis along the curve
